/* Generated by Cython 0.20.1 on Tue Mar 25 03:04:39 2014 */
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "HKW")) {
      if (unlikely(PyDict_SetItemString(modules, "HKW", __pyx_m) < 0)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
