...
def fixedSymbolWCVaRSPPortfolio(symbols, startDate, endDate,  money=1e6,
                           hist_periods=range(20, 130, 10), n_scenario=200,
                           buyTransFee=0.001425, sellTransFee=0.004425,
                           alpha=0.95, scenFunc="Moment", solver="cplex", 
...
#     parser.parse_args()
    ...
    parser.add_argument('-r', '--riskType', choices=['CVaR', 'WCVaR'], default="CVaR", help="risk type")
...
#         ExpResultsDir = os.path.join(ExpResultsDir, "LargestMarketValue_200501")
    ...
    if args.riskType == "CVaR":
        optFunc = fixedSymbolSPPortfolio
