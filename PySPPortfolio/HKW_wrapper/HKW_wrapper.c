/* Generated by Cython 0.20.1 on Fri Apr 11 00:47:19 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__PySPPortfolio__HKW_wrapper__HKW_wrapper
#define __PYX_HAVE_API__PySPPortfolio__HKW_wrapper__HKW_wrapper
#include "matrix.h"
#include "HKW_sg.h"
#include "string.h"
#include "stdio.h"
...
/* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":12
 * import numpy as np
 * DTYPE = np.float
 ...
 */
typedef __pyx_t_5numpy_float_t __pyx_t_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_DTYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'PySPPortfolio.HKW_wrapper.HKW_wrapper' */
static PyObject *__pyx_f_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_HeuristicMomentMatching(PyArrayObject *, PyArrayObject *, int, int, int, double, double, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "PySPPortfolio.HKW_wrapper.HKW_wrapper"
int __pyx_module_is_main_PySPPortfolio__HKW_wrapper__HKW_wrapper = 0;

/* Implementation of 'PySPPortfolio.HKW_wrapper.HKW_wrapper' */
static PyObject *__pyx_builtin_xrange;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_HeuristicMomentMatching(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_tgtMoms, PyArrayObject *__pyx_v_tgtCorrs, int __pyx_v_n_scenario, int __pyx_v_MaxTrial, int __pyx_v_HKW_MaxIter, double __pyx_v_MaxErrMom, double __pyx_v_MaxErrCorr); /* proto */
...
static char __pyx_k_MaxTrial[] = "MaxTrial";
static char __pyx_k_tgtCorrs[] = "tgtCorrs";
static char __pyx_k_MaxErrMom[] = "MaxErrMom";
static char __pyx_k_p_tarmoms[] = "p_tarmoms";
static char __pyx_k_p_tgcorrs[] = "p_tgcorrs";
static char __pyx_k_MaxErrCorr[] = "MaxErrCorr";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_n_scenario[] = "n_scenario";
static char __pyx_k_HKW_MaxIter[] = "HKW_MaxIter";
...
static PyObject *__pyx_n_s_HKW_MaxIter;
static PyObject *__pyx_n_s_MaxErrCorr;
static PyObject *__pyx_n_s_MaxErrMom;
static PyObject *__pyx_n_s_MaxTrial;
...
/* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":14
 * ctypedef np.float_t DTYPE_t
 * 
 * cpdef HeuristicMomentMatching(np.ndarray tgtMoms,             # <<<<<<<<<<<<<<
 *                              np.ndarray tgtCorrs,
...
static PyObject *__pyx_pw_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_1HeuristicMomentMatching(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_HeuristicMomentMatching(PyArrayObject *__pyx_v_tgtMoms, PyArrayObject *__pyx_v_tgtCorrs, int __pyx_v_n_scenario, int __pyx_v_MaxTrial, int __pyx_v_HKW_MaxIter, double __pyx_v_MaxErrMom, double __pyx_v_MaxErrCorr, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_n_rv;
  int __pyx_v_FormatOfTgMoms;
  int __pyx_v_TestLevel;
  unsigned char __pyx_v_UseStartDistrib;
  TMatrix __pyx_v_p_TarMoms;
  TMatrix __pyx_v_p_TgCorrs;
  TVector __pyx_v_p_Probs;
  TMatrix __pyx_v_OutMat;
  int __pyx_v_code;
  ...
  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":24
 *     cdef:
 *         int i, j
 ...
 */
  ...
  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":25
 *         int i, j
 *         int n_rv = tgtMoms.shape[0]
 *         int FormatOfTgMoms = 1             # <<<<<<<<<<<<<<
 * #         int MaxTrial = 50
 * #         int HKW_MaxIter = 50
 */
  __pyx_v_FormatOfTgMoms = 1;

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":30
 ...
 */
  ...
  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":31
 * #         double MaxErrCorr = 1e-3
 *         int TestLevel = 2
 *         unsigned char UseStartDistrib = 0             # <<<<<<<<<<<<<<
 *         TMatrix p_TarMoms
 *         TMatrix p_TgCorrs
 */
  __pyx_v_UseStartDistrib = 0;

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":37
 *         TMatrix OutMat
 * 
 ...
 */
  ...
  __pyx_t_1.ncol = 0;
  __pyx_t_1.val = NULL;
  __pyx_v_p_TarMoms = __pyx_t_1;

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":38
 * 
 *     p_TarMoms = TMatrix(0, 0, NULL)
 *     p_TgCorrs = TMatrix(0, 0, NULL)             # <<<<<<<<<<<<<<
 *     p_Probs = TVector(0, NULL)
 ...
 */
  ...
  __pyx_t_1.ncol = 0;
  __pyx_t_1.val = NULL;
  __pyx_v_p_TgCorrs = __pyx_t_1;

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":39
 *     p_TarMoms = TMatrix(0, 0, NULL)
 *     p_TgCorrs = TMatrix(0, 0, NULL)
 *     p_Probs = TVector(0, NULL)             # <<<<<<<<<<<<<<
 *     OutMat = TMatrix(0, 0, NULL)
 ...
 */
  __pyx_t_2.size = 0;
  __pyx_t_2.val = NULL;
  __pyx_v_p_Probs = __pyx_t_2;

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":40
 *     p_TgCorrs = TMatrix(0, 0, NULL)
 *     p_Probs = TVector(0, NULL)
 *     OutMat = TMatrix(0, 0, NULL)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":42
 *     OutMat = TMatrix(0, 0, NULL)
 * 
 *     Mat_Init(&p_TarMoms, 4, n_rv)             # <<<<<<<<<<<<<<
 ...
 */
  Mat_Init((&__pyx_v_p_TarMoms), 4, __pyx_v_n_rv);

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":43
 * 
 *     Mat_Init(&p_TarMoms, 4, n_rv)
 *     Mat_Init(&p_TgCorrs, n_rv, n_rv)             # <<<<<<<<<<<<<<
 *     Vec_Init(&p_Probs, n_scenario)
 ...
 */
  Mat_Init((&__pyx_v_p_TgCorrs), __pyx_v_n_rv, __pyx_v_n_rv);

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":44
 *     Mat_Init(&p_TarMoms, 4, n_rv)
 *     Mat_Init(&p_TgCorrs, n_rv, n_rv)
 *     Vec_Init(&p_Probs, n_scenario)             # <<<<<<<<<<<<<<
 *     Mat_Init(&OutMat, n_rv, n_scenario)
 * 
 */
  Vec_Init((&__pyx_v_p_Probs), __pyx_v_n_scenario);

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":45
 *     Mat_Init(&p_TgCorrs, n_rv, n_rv)
 *     Vec_Init(&p_Probs, n_scenario)
 *     Mat_Init(&OutMat, n_rv, n_scenario)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  Mat_Init((&__pyx_v_OutMat), __pyx_v_n_rv, __pyx_v_n_scenario);

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":47
 *     Mat_Init(&OutMat, n_rv, n_scenario)
 * 
 *     for i in xrange(n_rv):             # <<<<<<<<<<<<<<
 *         for j in xrange(4):
 ...
 */
  __pyx_t_3 = __pyx_v_n_rv;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":48
 * 
 *     for i in xrange(n_rv):
 *         for j in xrange(4):             # <<<<<<<<<<<<<<
 *             p_TarMoms.val[j][i] = tgtMoms[i][j]
 ...
 */
    for (__pyx_t_5 = 0; __pyx_t_5 < 4; __pyx_t_5+=1) {
      ...
      /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":49
 *     for i in xrange(n_rv):
 *         for j in xrange(4):
 *             p_TarMoms.val[j][i] = tgtMoms[i][j]             # <<<<<<<<<<<<<<
 * 
 *     for i in xrange(n_rv):
 */
      __pyx_t_6 = __Pyx_GetItemInt(((PyObject *)__pyx_v_tgtMoms), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_7 = __Pyx_GetItemInt(__pyx_t_6, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      ((__pyx_v_p_TarMoms.val[__pyx_v_j])[__pyx_v_i]) = __pyx_t_8;
    }
  }

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":51
 *             p_TarMoms.val[j][i] = tgtMoms[i][j]
 * 
 *     for i in xrange(n_rv):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":52
 * 
 *     for i in xrange(n_rv):
 *         for j in xrange(n_rv):             # <<<<<<<<<<<<<<
 *             p_TgCorrs.val[i][j] = tgtCorrs[i][j]
 * 
 */
    __pyx_t_5 = __pyx_v_n_rv;
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_5; __pyx_t_9+=1) {
      __pyx_v_j = __pyx_t_9;

      /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":53
 *     for i in xrange(n_rv):
 *         for j in xrange(n_rv):
 *             p_TgCorrs.val[i][j] = tgtCorrs[i][j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __Pyx_GetItemInt(((PyObject *)__pyx_v_tgtCorrs), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_6 = __Pyx_GetItemInt(__pyx_t_7, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_6); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      ((__pyx_v_p_TgCorrs.val[__pyx_v_i])[__pyx_v_j]) = __pyx_t_8;
    }
  }

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":55
 *             p_TgCorrs.val[i][j] = tgtCorrs[i][j]
 * 
 *     for i in xrange(n_scenario):             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_3 = __pyx_v_n_scenario;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":56
 * 
 *     for i in xrange(n_scenario):
 *         p_Probs.val[i] = 1./n_scenario             # <<<<<<<<<<<<<<
 * 
 ...
 */
    if (unlikely(__pyx_v_n_scenario == 0)) {
      #ifdef WITH_THREAD
      PyGILState_STATE __pyx_gilstate_save = PyGILState_Ensure();
      #endif
    ...
    (__pyx_v_p_Probs.val[__pyx_v_i]) = (1. / ((double)__pyx_v_n_scenario));
  }

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":58
 *         p_Probs.val[i] = 1./n_scenario
 * 
 *     Mat_Display(&p_TarMoms, "p_tarmoms")             # <<<<<<<<<<<<<<
 ...
 */
  Mat_Display((&__pyx_v_p_TarMoms), __pyx_k_p_tarmoms);

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":59
 * 
 *     Mat_Display(&p_TarMoms, "p_tarmoms")
 *     Mat_Display(&p_TgCorrs, "p_tgcorrs")             # <<<<<<<<<<<<<<
 *     #Vec_Display(&p_Probs, "p_Probs")
 * 
 */
  Mat_Display((&__pyx_v_p_TgCorrs), __pyx_k_p_tgcorrs);

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":62
 *     #Vec_Display(&p_Probs, "p_Probs")
 * 
 ...
 */
  __pyx_v_code = HKW_ScenGen(__pyx_v_FormatOfTgMoms, (&__pyx_v_p_TarMoms), (&__pyx_v_p_TgCorrs), (&__pyx_v_p_Probs), (&__pyx_v_OutMat), __pyx_v_MaxErrMom, __pyx_v_MaxErrCorr, __pyx_v_TestLevel, __pyx_v_MaxTrial, __pyx_v_HKW_MaxIter, __pyx_v_UseStartDistrib, NULL, NULL, NULL, NULL);

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":69
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_empty); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_n_rv); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_10 = __Pyx_PyInt_From_int(__pyx_v_n_scenario); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_11 = 0;
  __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_10, NULL); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  __pyx_v_scenarios = __pyx_t_11;
  __pyx_t_11 = 0;

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":70
 * 
 *     scenarios = np.empty((n_rv, n_scenario))
 *     for i in xrange(n_rv):             # <<<<<<<<<<<<<<
 *         for j in xrange(n_scenario):
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":71
 *     scenarios = np.empty((n_rv, n_scenario))
 *     for i in xrange(n_rv):
 *         for j in xrange(n_scenario):             # <<<<<<<<<<<<<<
 *             scenarios[i][j] = OutMat.val[i][j]
 * 
 */
    __pyx_t_5 = __pyx_v_n_scenario;
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_5; __pyx_t_9+=1) {
      __pyx_v_j = __pyx_t_9;

      /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":72
 *     for i in xrange(n_rv):
 *         for j in xrange(n_scenario):
 *             scenarios[i][j] = OutMat.val[i][j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_11 = PyFloat_FromDouble(((__pyx_v_OutMat.val[__pyx_v_i])[__pyx_v_j])); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_10 = __Pyx_GetItemInt(__pyx_v_scenarios, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_10 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_10);
      if (unlikely(__Pyx_SetItemInt(__pyx_t_10, __pyx_v_j, __pyx_t_11, int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    }
  }

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":75
 * 
 *     #De-allocate matrices
 *     Mat_Kill(&p_TarMoms)             # <<<<<<<<<<<<<<
 *     Mat_Kill(&p_TgCorrs)
 *     Mat_Kill(&OutMat)
 */
  Mat_Kill((&__pyx_v_p_TarMoms));

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":76
 *     #De-allocate matrices
 *     Mat_Kill(&p_TarMoms)
 *     Mat_Kill(&p_TgCorrs)             # <<<<<<<<<<<<<<
 *     Mat_Kill(&OutMat)
 *     Vec_Kill(&p_Probs)
 */
  Mat_Kill((&__pyx_v_p_TgCorrs));

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":77
 *     Mat_Kill(&p_TarMoms)
 *     Mat_Kill(&p_TgCorrs)
 *     Mat_Kill(&OutMat)             # <<<<<<<<<<<<<<
 *     Vec_Kill(&p_Probs)
 * 
 */
  Mat_Kill((&__pyx_v_OutMat));

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":78
 *     Mat_Kill(&p_TgCorrs)
 *     Mat_Kill(&OutMat)
 *     Vec_Kill(&p_Probs)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  Vec_Kill((&__pyx_v_p_Probs));

  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":81
 * 
 * 
 ...
 */
  ...
  __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_code); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_10 = PyTuple_New(2); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_INCREF(__pyx_v_scenarios);
  PyTuple_SET_ITEM(__pyx_t_10, 0, __pyx_v_scenarios);
  __Pyx_GIVEREF(__pyx_v_scenarios);
 ...
 */
  ...
  __Pyx_AddTraceback("PySPPortfolio.HKW_wrapper.HKW_wrapper.HeuristicMomentMatching", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_1HeuristicMomentMatching(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_1HeuristicMomentMatching(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_tgtMoms = 0;
  PyArrayObject *__pyx_v_tgtCorrs = 0;
  int __pyx_v_n_scenario;
  int __pyx_v_MaxTrial;
  int __pyx_v_HKW_MaxIter;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_tgtMoms,&__pyx_n_s_tgtCorrs,&__pyx_n_s_n_scenario,&__pyx_n_s_MaxTrial,&__pyx_n_s_HKW_MaxIter,&__pyx_n_s_MaxErrMom,&__pyx_n_s_MaxErrCorr,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tgtCorrs)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 7, 7, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_scenario)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 7, 7, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_MaxTrial)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 7, 7, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_HKW_MaxIter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 7, 7, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_MaxErrMom)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 7, 7, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_MaxErrCorr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 7, 7, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "HeuristicMomentMatching") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_n_scenario = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_n_scenario == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_MaxTrial = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_MaxTrial == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_HKW_MaxIter = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_HKW_MaxIter == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_MaxErrMom = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_MaxErrMom == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_MaxErrCorr = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_MaxErrCorr == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("PySPPortfolio.HKW_wrapper.HKW_wrapper.HeuristicMomentMatching", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_tgtMoms), __pyx_ptype_5numpy_ndarray, 1, "tgtMoms", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_tgtCorrs), __pyx_ptype_5numpy_ndarray, 1, "tgtCorrs", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_HeuristicMomentMatching(__pyx_self, __pyx_v_tgtMoms, __pyx_v_tgtCorrs, __pyx_v_n_scenario, __pyx_v_MaxTrial, __pyx_v_HKW_MaxIter, __pyx_v_MaxErrMom, __pyx_v_MaxErrCorr);
...
static PyObject *__pyx_pf_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_HeuristicMomentMatching(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_tgtMoms, PyArrayObject *__pyx_v_tgtCorrs, int __pyx_v_n_scenario, int __pyx_v_MaxTrial, int __pyx_v_HKW_MaxIter, double __pyx_v_MaxErrMom, double __pyx_v_MaxErrCorr) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("HeuristicMomentMatching", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_HeuristicMomentMatching(__pyx_v_tgtMoms, __pyx_v_tgtCorrs, __pyx_v_n_scenario, __pyx_v_MaxTrial, __pyx_v_HKW_MaxIter, __pyx_v_MaxErrMom, __pyx_v_MaxErrCorr, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("HeuristicMomentMatching"), (PyCFunction)__pyx_pw_13PySPPortfolio_11HKW_wrapper_11HKW_wrapper_1HeuristicMomentMatching, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_HKW_MaxIter, __pyx_k_HKW_MaxIter, sizeof(__pyx_k_HKW_MaxIter), 0, 0, 1, 1},
  {&__pyx_n_s_MaxErrCorr, __pyx_k_MaxErrCorr, sizeof(__pyx_k_MaxErrCorr), 0, 0, 1, 1},
  {&__pyx_n_s_MaxErrMom, __pyx_k_MaxErrMom, sizeof(__pyx_k_MaxErrMom), 0, 0, 1, 1},
  {&__pyx_n_s_MaxTrial, __pyx_k_MaxTrial, sizeof(__pyx_k_MaxTrial), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initHKW_wrapper(void); /*proto*/
PyMODINIT_FUNC initHKW_wrapper(void)
#else
PyMODINIT_FUNC PyInit_HKW_wrapper(void); /*proto*/
PyMODINIT_FUNC PyInit_HKW_wrapper(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_HKW_wrapper(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("HKW_wrapper"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_Created_on_2014_3_11_author_Hun), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_PySPPortfolio__HKW_wrapper__HKW_wrapper) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "PySPPortfolio.HKW_wrapper.HKW_wrapper")) {
      if (unlikely(PyDict_SetItemString(modules, "PySPPortfolio.HKW_wrapper.HKW_wrapper", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":10
 * cimport HKW_wrapper
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * DTYPE = np.float
 ...
 */
  ...
  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":11
 * cimport numpy as np
 * import numpy as np
 * DTYPE = np.float             # <<<<<<<<<<<<<<
 * ctypedef np.float_t DTYPE_t
 ...
 */
  ...
  /* "PySPPortfolio/HKW_wrapper/HKW_wrapper.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * '''
 * Created on 2014/3/11
 */
 ...
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init PySPPortfolio.HKW_wrapper.HKW_wrapper", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init PySPPortfolio.HKW_wrapper.HKW_wrapper");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
