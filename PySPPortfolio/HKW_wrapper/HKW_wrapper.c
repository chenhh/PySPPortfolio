/* Generated by Cython 0.20.1 on Thu Apr 10 13:43:02 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__PySPPortfolio__HKWWrapper__HKW_wrapper
#define __PYX_HAVE_API__PySPPortfolio__HKWWrapper__HKW_wrapper
#include "matrix.h"
#include "HKW_sg.h"
#include "string.h"
#include "stdio.h"
...
/* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":12
 * import numpy as np
 * DTYPE = np.float
 ...
 */
typedef __pyx_t_5numpy_float_t __pyx_t_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_DTYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'PySPPortfolio.HKWWrapper.HKW_wrapper' */
static PyObject *__pyx_f_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_HeuristicMomentMatching(PyArrayObject *, PyArrayObject *, int, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "PySPPortfolio.HKWWrapper.HKW_wrapper"
int __pyx_module_is_main_PySPPortfolio__HKWWrapper__HKW_wrapper = 0;

/* Implementation of 'PySPPortfolio.HKWWrapper.HKW_wrapper' */
static PyObject *__pyx_builtin_xrange;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_HeuristicMomentMatching(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_tgtMoms, PyArrayObject *__pyx_v_tgtCorrs, int __pyx_v_n_scenario); /* proto */
...
static char __pyx_k_p_Probs[] = "p_Probs";
...
/* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":14
 * ctypedef np.float_t DTYPE_t
 * 
 * cpdef HeuristicMomentMatching(np.ndarray tgtMoms,             # <<<<<<<<<<<<<<
 *                              np.ndarray tgtCorrs,
...
static PyObject *__pyx_pw_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_1HeuristicMomentMatching(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_HeuristicMomentMatching(PyArrayObject *__pyx_v_tgtMoms, PyArrayObject *__pyx_v_tgtCorrs, int __pyx_v_n_scenario, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_n_rv;
  int __pyx_v_FormatOfTgMoms;
  int __pyx_v_MaxTrial;
  PyObject *__pyx_v_HKW_MaxIter = 0;
  ...
  CYTHON_UNUSED int __pyx_v_code;
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":19
 *     cdef:
 *         int i, j
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":20
 *         int i, j
 *         int n_rv = tgtMoms.shape[0]
 *         int FormatOfTgMoms = 1             # <<<<<<<<<<<<<<
 *         int MaxTrial = 10
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":21
 *         int n_rv = tgtMoms.shape[0]
 *         int FormatOfTgMoms = 1
 *         int MaxTrial = 10             # <<<<<<<<<<<<<<
 *         HKW_MaxIter = 20
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":22
 *         int FormatOfTgMoms = 1
 *         int MaxTrial = 10
 *         HKW_MaxIter = 20             # <<<<<<<<<<<<<<
 *         double MaxErrMom = 1e-3
 ...
 */
  ...
  __pyx_v_HKW_MaxIter = __pyx_int_20;

  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":23
 *         int MaxTrial = 10
 *         HKW_MaxIter = 20
 *         double MaxErrMom = 1e-3             # <<<<<<<<<<<<<<
 *         double MaxErrCorr = 1e-3
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":24
 *         HKW_MaxIter = 20
 *         double MaxErrMom = 1e-3
 *         double MaxErrCorr = 1e-3             # <<<<<<<<<<<<<<
 *         int TestLevel = 2
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":25
 *         double MaxErrMom = 1e-3
 *         double MaxErrCorr = 1e-3
 *         int TestLevel = 2             # <<<<<<<<<<<<<<
 *         unsigned char UseStartDistrib = 0
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":26
 *         double MaxErrCorr = 1e-3
 *         int TestLevel = 2
 *         unsigned char UseStartDistrib = 0             # <<<<<<<<<<<<<<
 *         TMatrix p_TarMoms
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":32
 *         TMatrix OutMat
 * 
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":33
 * 
 *     p_TarMoms = TMatrix(0, 0, NULL)
 *     p_TgCorrs = TMatrix(0, 0, NULL)             # <<<<<<<<<<<<<<
 *     p_Probs = TVector(0, NULL)
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":34
 *     p_TarMoms = TMatrix(0, 0, NULL)
 *     p_TgCorrs = TMatrix(0, 0, NULL)
 *     p_Probs = TVector(0, NULL)             # <<<<<<<<<<<<<<
 *     OutMat = TMatrix(0, 0, NULL)
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":35
 *     p_TgCorrs = TMatrix(0, 0, NULL)
 *     p_Probs = TVector(0, NULL)
 *     OutMat = TMatrix(0, 0, NULL)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":37
 *     OutMat = TMatrix(0, 0, NULL)
 * 
 *     Mat_Init(&p_TarMoms, 4, n_rv)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":38
 * 
 *     Mat_Init(&p_TarMoms, 4, n_rv)
 *     Mat_Init(&p_TgCorrs, n_rv, n_rv)             # <<<<<<<<<<<<<<
 *     Vec_Init(&p_Probs, n_scenario)
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":39
 *     Mat_Init(&p_TarMoms, 4, n_rv)
 *     Mat_Init(&p_TgCorrs, n_rv, n_rv)
 *     Vec_Init(&p_Probs, n_scenario)             # <<<<<<<<<<<<<<
 *     Mat_Init(&OutMat, n_rv, n_scenario)
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":40
 *     Mat_Init(&p_TgCorrs, n_rv, n_rv)
 *     Vec_Init(&p_Probs, n_scenario)
 *     Mat_Init(&OutMat, n_rv, n_scenario)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":42
 *     Mat_Init(&OutMat, n_rv, n_scenario)
 * 
 *     for i in xrange(n_rv):             # <<<<<<<<<<<<<<
 *         for j in xrange(4):
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":43
 * 
 *     for i in xrange(n_rv):
 *         for j in xrange(4):             # <<<<<<<<<<<<<<
 *             p_TarMoms.val[j][i] = tgtMoms[i][j]
 ...
 */
    for (__pyx_t_5 = 0; __pyx_t_5 < 4; __pyx_t_5+=1) {
      ...
      /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":44
 *     for i in xrange(n_rv):
 *         for j in xrange(4):
 *             p_TarMoms.val[j][i] = tgtMoms[i][j]             # <<<<<<<<<<<<<<
 * 
 *     for i in xrange(n_rv):
 */
      __pyx_t_6 = __Pyx_GetItemInt(((PyObject *)__pyx_v_tgtMoms), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_7 = __Pyx_GetItemInt(__pyx_t_6, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      ((__pyx_v_p_TarMoms.val[__pyx_v_j])[__pyx_v_i]) = __pyx_t_8;
    }
  }

  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":46
 *             p_TarMoms.val[j][i] = tgtMoms[i][j]
 * 
 *     for i in xrange(n_rv):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":47
 * 
 *     for i in xrange(n_rv):
 *         for j in xrange(n_rv):             # <<<<<<<<<<<<<<
 *             p_TgCorrs.val[i][j] = tgtCorrs[i][j]
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_5; __pyx_t_9+=1) {
      ...
      /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":48
 *     for i in xrange(n_rv):
 *         for j in xrange(n_rv):
 *             p_TgCorrs.val[i][j] = tgtCorrs[i][j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __Pyx_GetItemInt(((PyObject *)__pyx_v_tgtCorrs), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_6 = __Pyx_GetItemInt(__pyx_t_7, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_6); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      ((__pyx_v_p_TgCorrs.val[__pyx_v_i])[__pyx_v_j]) = __pyx_t_8;
    }
  }

  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":50
 *             p_TgCorrs.val[i][j] = tgtCorrs[i][j]
 * 
 *     for i in xrange(n_scenario):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":51
 * 
 *     for i in xrange(n_scenario):
 *         p_Probs.val[i] = 1./n_scenario             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":53
 *         p_Probs.val[i] = 1./n_scenario
 * 
 *     Mat_Display(&p_TarMoms, "p_tarmoms")             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":54
 * 
 *     Mat_Display(&p_TarMoms, "p_tarmoms")
 *     Mat_Display(&p_TgCorrs, "p_tgcorrs")             # <<<<<<<<<<<<<<
 *     Vec_Display(&p_Probs, "p_Probs")
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":55
 *     Mat_Display(&p_TarMoms, "p_tarmoms")
 *     Mat_Display(&p_TgCorrs, "p_tgcorrs")
 *     Vec_Display(&p_Probs, "p_Probs")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  Vec_Display((&__pyx_v_p_Probs), __pyx_k_p_Probs);

  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":58
 * 
 *     code = HKW_ScenGen(FormatOfTgMoms, &p_TarMoms, &p_TgCorrs, &p_Probs, &OutMat,
 ...
 *             )
 */
  __pyx_t_3 = __Pyx_PyInt_As_int(__pyx_v_HKW_MaxIter); if (unlikely((__pyx_t_3 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":57
 *     Vec_Display(&p_Probs, "p_Probs")
 * 
 *     code = HKW_ScenGen(FormatOfTgMoms, &p_TarMoms, &p_TgCorrs, &p_Probs, &OutMat,             # <<<<<<<<<<<<<<
 *                 MaxErrMom, MaxErrCorr, TestLevel, MaxTrial, HKW_MaxIter,
 *                 UseStartDistrib, NULL, NULL, NULL, NULL
 */
  __pyx_v_code = HKW_ScenGen(__pyx_v_FormatOfTgMoms, (&__pyx_v_p_TarMoms), (&__pyx_v_p_TgCorrs), (&__pyx_v_p_Probs), (&__pyx_v_OutMat), __pyx_v_MaxErrMom, __pyx_v_MaxErrCorr, __pyx_v_TestLevel, __pyx_v_MaxTrial, __pyx_t_3, __pyx_v_UseStartDistrib, NULL, NULL, NULL, NULL);

  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":62
 *             )
 * 
 ...
 */
  Mat_Display((&__pyx_v_OutMat), __pyx_k_OutMat);

  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":64
 *     Mat_Display(&OutMat, "OutMat")
 * 
 *     scenarios = np.empty((n_rv, n_scenario))             # <<<<<<<<<<<<<<
 *     for i in xrange(n_rv):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_n_rv); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_10 = __Pyx_PyInt_From_int(__pyx_v_n_scenario); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_11 = 0;
  __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_10, NULL); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":65
 * 
 *     scenarios = np.empty((n_rv, n_scenario))
 *     for i in xrange(n_rv):             # <<<<<<<<<<<<<<
 *         for j in xrange(n_scenario):
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":66
 *     scenarios = np.empty((n_rv, n_scenario))
 *     for i in xrange(n_rv):
 *         for j in xrange(n_scenario):             # <<<<<<<<<<<<<<
 *             scenarios[i][j] = OutMat.val[i][j]
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_5; __pyx_t_9+=1) {
      ...
      /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":67
 *     for i in xrange(n_rv):
 *         for j in xrange(n_scenario):
 *             scenarios[i][j] = OutMat.val[i][j]             # <<<<<<<<<<<<<<
 * 
 *     return scenarios
 */
      __pyx_t_11 = PyFloat_FromDouble(((__pyx_v_OutMat.val[__pyx_v_i])[__pyx_v_j])); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_10 = __Pyx_GetItemInt(__pyx_v_scenarios, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_10 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_10);
      if (unlikely(__Pyx_SetItemInt(__pyx_t_10, __pyx_v_j, __pyx_t_11, int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    }
  }

  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":69
 *             scenarios[i][j] = OutMat.val[i][j]
 * 
 *     return scenarios             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("PySPPortfolio.HKWWrapper.HKW_wrapper.HeuristicMomentMatching", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_HKW_MaxIter);
...
/* Python wrapper */
static PyObject *__pyx_pw_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_1HeuristicMomentMatching(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_1HeuristicMomentMatching(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tgtCorrs)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_scenario)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("HeuristicMomentMatching", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("PySPPortfolio.HKWWrapper.HKW_wrapper.HeuristicMomentMatching", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_HeuristicMomentMatching(__pyx_self, __pyx_v_tgtMoms, __pyx_v_tgtCorrs, __pyx_v_n_scenario);
...
static PyObject *__pyx_pf_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_HeuristicMomentMatching(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_tgtMoms, PyArrayObject *__pyx_v_tgtCorrs, int __pyx_v_n_scenario) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("HeuristicMomentMatching", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_HeuristicMomentMatching(__pyx_v_tgtMoms, __pyx_v_tgtCorrs, __pyx_v_n_scenario, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("HeuristicMomentMatching"), (PyCFunction)__pyx_pw_13PySPPortfolio_10HKWWrapper_11HKW_wrapper_1HeuristicMomentMatching, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_PySPPortfolio__HKWWrapper__HKW_wrapper) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "PySPPortfolio.HKWWrapper.HKW_wrapper")) {
      if (unlikely(PyDict_SetItemString(modules, "PySPPortfolio.HKWWrapper.HKW_wrapper", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":10
 * cimport HKW_wrapper
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * DTYPE = np.float
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":11
 * cimport numpy as np
 * import numpy as np
 * DTYPE = np.float             # <<<<<<<<<<<<<<
 * ctypedef np.float_t DTYPE_t
 ...
 */
  ...
  /* "PySPPortfolio/HKWWrapper/HKW_wrapper.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * '''
 * Created on 2014/3/11
 */
 ...
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init PySPPortfolio.HKWWrapper.HKW_wrapper", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init PySPPortfolio.HKWWrapper.HKW_wrapper");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
