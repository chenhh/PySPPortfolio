/* Generated by Cython 0.20.1 on Thu Apr 10 19:33:30 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__PySPPortfolio__scenario__HeuristicCopula
#define __PYX_HAVE_API__PySPPortfolio__scenario__HeuristicCopula
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* "PySPPortfolio\scenario\HeuristicCopula.pyx":10
 * import numpy as np
 * DTYPE = np.float
 ...
 */
typedef __pyx_t_5numpy_float_t __pyx_t_13PySPPortfolio_8scenario_15HeuristicCopula_DTYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'PySPPortfolio.scenario.HeuristicCopula' */
static PyObject *__pyx_f_13PySPPortfolio_8scenario_15HeuristicCopula_HeuristicCopula(PyArrayObject *, double, int, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "PySPPortfolio.scenario.HeuristicCopula"
int __pyx_module_is_main_PySPPortfolio__scenario__HeuristicCopula = 0;

/* Implementation of 'PySPPortfolio.scenario.HeuristicCopula' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_13PySPPortfolio_8scenario_15HeuristicCopula_HeuristicCopula(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_data, double __pyx_v_alpha, int __pyx_v_n_scenario); /* proto */
...
/* "PySPPortfolio\scenario\HeuristicCopula.pyx":13
 * 
 * # @cython.boundscheck(False)
...
static PyObject *__pyx_pw_13PySPPortfolio_8scenario_15HeuristicCopula_1HeuristicCopula(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_13PySPPortfolio_8scenario_15HeuristicCopula_HeuristicCopula(CYTHON_UNUSED PyArrayObject *__pyx_v_data, CYTHON_UNUSED double __pyx_v_alpha, CYTHON_UNUSED int __pyx_v_n_scenario, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("HeuristicCopula", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_13PySPPortfolio_8scenario_15HeuristicCopula_1HeuristicCopula(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_13PySPPortfolio_8scenario_15HeuristicCopula_HeuristicCopula[] = "\n    @data, numpy.array, size: N*D, N is num. of data, D is dimensions\n    @alpha, float, confidence level of CVaR\n    @n_scenario, integer\n    ";
static PyObject *__pyx_pw_13PySPPortfolio_8scenario_15HeuristicCopula_1HeuristicCopula(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("HeuristicCopula (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_alpha,&__pyx_n_s_n_scenario,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("HeuristicCopula", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_scenario)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("HeuristicCopula", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "HeuristicCopula") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_n_scenario = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_n_scenario == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("HeuristicCopula", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("PySPPortfolio.scenario.HeuristicCopula.HeuristicCopula", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_13PySPPortfolio_8scenario_15HeuristicCopula_HeuristicCopula(__pyx_self, __pyx_v_data, __pyx_v_alpha, __pyx_v_n_scenario);
...
static PyObject *__pyx_pf_13PySPPortfolio_8scenario_15HeuristicCopula_HeuristicCopula(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_data, double __pyx_v_alpha, int __pyx_v_n_scenario) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_t_1 = __pyx_f_13PySPPortfolio_8scenario_15HeuristicCopula_HeuristicCopula(__pyx_v_data, __pyx_v_alpha, __pyx_v_n_scenario, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("HeuristicCopula"), (PyCFunction)__pyx_pw_13PySPPortfolio_8scenario_15HeuristicCopula_1HeuristicCopula, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_13PySPPortfolio_8scenario_15HeuristicCopula_HeuristicCopula)},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initHeuristicCopula(void); /*proto*/
PyMODINIT_FUNC initHeuristicCopula(void)
#else
PyMODINIT_FUNC PyInit_HeuristicCopula(void); /*proto*/
PyMODINIT_FUNC PyInit_HeuristicCopula(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_HeuristicCopula(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("HeuristicCopula"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_author_Hung_Hsin_Chen_mail_chen), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_PySPPortfolio__scenario__HeuristicCopula) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "PySPPortfolio.scenario.HeuristicCopula")) {
      if (unlikely(PyDict_SetItemString(modules, "PySPPortfolio.scenario.HeuristicCopula", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "PySPPortfolio\scenario\HeuristicCopula.pyx":8
 ...
 */
  ...
  /* "PySPPortfolio\scenario\HeuristicCopula.pyx":9
 * cimport numpy as np
 * import numpy as np
 * DTYPE = np.float             # <<<<<<<<<<<<<<
 * ctypedef np.float_t DTYPE_t
 ...
 */
  ...
  /* "PySPPortfolio\scenario\HeuristicCopula.pyx":24
 * 
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = (__Pyx_PyString_Equals(__pyx_t_2, __pyx_n_s_main, Py_EQ)); if (unlikely(__pyx_t_3 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_3) {
    goto __pyx_L2;
  }
  ...
  /* "PySPPortfolio\scenario\HeuristicCopula.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * '''
 * @author: Hung-Hsin Chen
 */
 ...
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init PySPPortfolio.scenario.HeuristicCopula", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init PySPPortfolio.scenario.HeuristicCopula");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
