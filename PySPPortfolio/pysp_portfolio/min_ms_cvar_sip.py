...
def min_ms_cvar_sip_portfolio(symbols, trans_dates, risk_rois, risk_free_rois,
    ...
    # concrete model
    instance = ConcreteModel(name="ms_min_cvar_sip_portfolio")
    ...
    instance.chosen = Var(instance.exp_periods, instance.symbols,
                          within=Binary)
