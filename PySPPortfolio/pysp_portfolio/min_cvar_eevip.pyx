...
def min_cvar_eevip_portfolio(symbols,
...
class MinCVaREEVIPPortfolio(MinCVaRSPPortfolio):
    """
    ...
    def __init__(self,  candidate_symbols,
        ...
        super(MinCVaREEVIPPortfolio, self).__init__(
    ...
    def get_current_buy_sell_amounts(self, *args, **kwargs):
        ...
        tdx = kwargs['tdx']
        results = min_cvar_eevip_portfolio(
            self.symbols,
